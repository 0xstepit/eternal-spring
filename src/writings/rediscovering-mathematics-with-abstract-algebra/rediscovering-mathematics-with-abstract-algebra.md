...
tags: [algebra, learning, deep-dive]
related: []
to-publish: true
---
...
three main mathematical structures:
...
2. Existence of the neutral element:
   $\exists e \in \mathbb{G} : eg = g, \, \forall g \in \mathbb{G}$.

3. Existence of the inverse element:
...
group in which also the order of operation is not important:
